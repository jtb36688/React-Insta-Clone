...
- To start off today, your application should still be structured like yesterday, but now it should have a work+ing search bar, comment input, and like icon.
